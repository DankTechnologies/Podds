<script lang="ts">
	...
	let importFeedIds = $state<string>(
		'6596894,637281,5320480,1074603,3240656,522889,1329334,542376,853158,3745116,1052374,5928182,743229,6752757,548735,223113,214340,309699,577105,1077200,533288,318113,910728,480976,561997,555339,5775917,165630,6660056,460150'
	);
